<template>
    <header class="relative flex flex-row justify-between items-center p-1 px-3 lg:px-1 h-[50px] my-auto border-b border-neutral-300 dark:border-neutral-700">
        <button class="z-30" aria-label="configure" @click="ViewConfiguration()">
        ...
        <div class="flex flex-row gap-3 z-30">
            <button class="m-0 sm:my-1" aria-label="statistics" @click="ViewStatistics()">
            ...
            <button class="m-0 sm:my-1" aria-label="about" @click="ViewAbout()">
...
const { ViewConfiguration, ViewStatistics, ViewAbout  } = mapActions<ScreensActions>('screens');
</script>