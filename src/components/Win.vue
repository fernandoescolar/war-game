    ...
    <Modal title="" :visible="win" :showClose="false">
      <div v-if="win">
        ...
        <div ref="text">
            ...
            <span v-if="humanInitialArmies === initialArmies">🤘</span>
            <span v-if="humanInitialArmies < initialArmies">🤟</span>
            <span v-if="humanIndex === 0">🍭</span>
            <span v-if="humanIndex === numberOfPlayers - 1">💪</span>
            <span v-if="humanIndex < numberOfPlayers - 1 && humanIndex > 0">👍</span>
        </div>
        <div class="center">
...
h1 {
  margin-top: 0.5em !important;
  font-size: calc($title-font-size * 2) !important;
  text-align: center;
}
